...
# OTO-LOGİN: Güvenlik duvarlarına takılmamak için kullanıcı ana dizinine kaydedilir.
...
# Mac ve Windows için Font Optimizasyonu (Gecikmeyi önler)
LUXURY_THEME_QSS = """
...
class MainWindow(QMainWindow):
    def __init__(self, user_email=""):
        ...
        # SÜRE GÖSTERGESİ (DEVASA KUTU YERİNE BURAYA EKLENDİ)
        ...
        l_o.addWidget(self.lbl_license, 1, 2, 1, 2) # Tam Record butonunun yanında
    ...
    def check_updates(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                latest_version = data['fields']['latestVersion']['stringValue']
                
                if sys.platform == "win32":
                    download_url = data['fields']['downloadUrlWin']['stringValue']
                else:
                    download_url = data['fields']['downloadUrlMac']['stringValue']
    ...
    def perform_autonomous_update(self, download_url):
        ...
        progress.setWindowTitle("Güncelleniyor")
        progress.setText("Yeni sürüm indiriliyor, lütfen bekleyin...\nBu işlem bağlantı hızınıza göre 1-2 dakika sürebilir.")
...
"""
                ...
                sys.exit() # Eski program kendini imha eder
            else:
                QMessageBox.information(self, "Bilgi", "Bu özellik sadece derlenmiş EXE/APP sürümlerinde çalışır.")
